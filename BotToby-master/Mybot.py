...
cl = LINETCR.LINE()
cl.login(token="EmSpYyNuZ3U5XpVQ6wz5.77WNn1FlYG4c0oYrm4Arfq.I1TxV8U5KwNKalYVjOZQ1gpSW4dsuM2w8vL3M5rSyDs=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmcXG1Lg54kJYlZYMWC9.s7kBxhhGqXikWwW6uuWkMq.glAuiRbeKj95nDVKtH6s4mTHdCBR0iOsxa/H3qj19j8=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmOfFUKTu1pHl8YErMl5.8WbXERpKSncKj7hphgF6nq.3ctOZw/aD9J59g5ysRUq6ZC0fvonBdPbjcdIKsPDG2o=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmpSMPJHZuWBSrfrK0K2.C9TSt7he0ZpSKOhG4eFNiG.o3OEgO5OjypJJ1iokLZgbPI8fu+PyVWxn9drzt5g4y4=")
ks.loginResult()
...
Help Message =""" ◾ƬΣΛM ПΣЩBIΣ BӨƬ◾

☁̸҉̸.̸҉ =ᓧøммåńđ вøτ ̸҉̸.̸҉̸☁
☢[Me]
☢[My mid]
☢[Bot?]
☢[Id Group]
...
Setgroup =""" Private Menu ☸B̳O̳T̳ L̳I̳N̳E̳ E̳D̳I̳T̳E̳D̳☸ ♻ƬΣΛM ПΣЩBIΣ BӨƬ♻
...
Cmid = ks.getProfile().mid

Bots=[mid,Amid,Bmid,Cmid,]
admin=["uefbc273757cbca0e02d0ec9133869115"]
owner=["uefbc273757cbca0e02d0ec9133869115"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 25:
	       ...
	       if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Owner by GUNTUR TD")
		   ...
		   if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    ks.updateGroup(X)
                    if wait["lang"] == "JP":
                        ks.sendText(msg.to,"Done Chivas")
                    else:
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                        ks.updateGroup(x)
                    gurl = ks.reissueGroupTicket(msg.to)
                    ks.sendText(msg.to,"line://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can't be used outside the group")
                    else:
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
                ...
                if wait["clock"] == True:
                    ks.sendText(msg.to,"Bot 4 jam on")
                else:
                    wait["clock"] = True
                    now2 = datetime.now()
                    ...
                    ks.sendText(msg.to,"Jam Selalu On")
            elif msg.text in ["Jam off"]:
                if wait["clock"] == False:
                    ks.sendText(msg.to,"Bot 4 jam off")
                else:
                    wait["clock"] = False
                    ks.sendText(msg.to,"Jam Sedang Off")
         ...
         #-------------Fungsi Jam Update Start---------------------#            
                ...
                if wait["clock"] == True:
                    ...
                    ks.sendText(msg.to,"Aktifkan jam terlebih dulu")
...
#------------------------------------------------
       ...
       #--------------Fungsi Broadcast Finish-----------#
                ...
                ks.sendText(msg.to,"Hi buddy 􀜁􀅔Har Har􏿿")
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
			...
			cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by k̶a̶n̶g̶ E̶d̶i̶t̶o̶r̶ TD GUNTUR")
